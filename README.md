...
4. **Data Visualization:** Any of the `S4`-`S15` Python pipelines can be targeted directly to regenerate high-DPI `.png` files found in the `src/04_Figures` envelope. 
...
![Transmission Hotspots](src/04_Figures/Fig_Geo_Clusters_LHR_RWP.png)
...
![Dengue Burden vs Population](src/04_Figures/Fig_Population_vs_Dengue_Bubble.png)
...
![Seasonal Temp](src/04_Figures/Fig_Seasonal_Weather_Temp_May_Dec.png)
![Seasonal Rain](src/04_Figures/Fig_Seasonal_Weather_Rain_May_Dec.png)
...
![North TimeSeries](src/04_Figures/Fig09_North_TimeSeries.png)
![Central TimeSeries](src/04_Figures/Fig09_Central_TimeSeries.png)
![South TimeSeries](src/04_Figures/Fig09_South_TimeSeries.png)
...
![Thermal Curves](src/04_Figures/FigS1_ThermalCurves.png)
...
![Pearson Forest Plot](src/04_Figures/Fig11_PearsonCI_Forest.png)
